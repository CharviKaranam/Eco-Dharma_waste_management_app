...
const navItems: NavItem[] = [
  ...
  { href: '/dashboard/upload-waste', label: 'AI Classifier', icon: UploadCloud, roles: ['Household', 'Recycler'] },
  { href: '/dashboard/upcycle-studio', label: 'Upcycle Studio', icon: Paintbrush, roles: ['Household', 'SHG'] },
  { href: '/dashboard/community-ideas', label: 'Community Ideas', icon: Lightbulb, roles: ['Household', 'SHG', 'NGO', 'Admin'] }, // Added new nav item
  { href: '/dashboard/take-action', label: 'Take Action', icon: Zap, roles: ['Household'] },
  { href: '/dashboard/track-waste', label: 'Track Waste', icon: BarChartBig, roles: ['Household', 'Recycler'] },
  { href: '/dashboard/oil-to-soap', label: 'Oil to Soap', icon: Droplets, roles: ['Household', 'SHG'] },
  ...
  { href: '/dashboard/community', label: 'Community Forum', icon: MessageCircle, roles: ['Household', 'Recycler', 'NGO', 'Admin', 'SHG'] },
  { href: '/dashboard/rewards', label: 'Rewards', icon: Gift, roles: ['Household'] },
