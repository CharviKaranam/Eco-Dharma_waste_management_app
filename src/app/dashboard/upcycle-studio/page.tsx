...
import { Loader2, Paintbrush, AlertCircle, Youtube, Send, PlusCircle, Eye, Lightbulb, Image as ImageIcon, Upload } from 'lucide-react';
      ...
      <Card className="shadow-lg">
        ...
        <CardContent className="flex flex-col sm:flex-row gap-4">
          ...
          <Button asChild variant="outline" className="w-full sm:w-auto">
            <Link href="/dashboard/community-ideas">
              <Eye className="mr-2 h-4 w-4" /> View Community Ideas
            </Link>
          </Button>
        </CardContent>
      </Card>
